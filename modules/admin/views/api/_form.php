...
<div class="api-form">
    ...
    <?= $form->field($model, 'service_id')->radioList(ApiService::loadOptions())?>

    <?= $form->field($model, 'platforms')->checkboxList(ApiClientPlatform::loadBitOptions($model->service_id)) ?>
...
function domReady(){
	...
	$('input[name="Api[service_id]"]').click(function(){
		var zhi  = $(this).val();
		if(zhi){
			$.ajax({
	            type:"POST",
	...
	$('.cs_add').click(function(){
		num++;
		$(this).parents('table').append("<tr data-tr='"+num+"'><td class='cs_first'><input name='cs_name[]' value='' class='cs_input first_input' type='text'/></td><td><input name='cs_label[]' value='' class='cs_input' type='text'/></td><td><input name='cs_desc[]' value='' class='cs_input' type='text'/></td><td><input name='cs_val[]' value='' class='cs_input' type='text'/></td><td class='cs_th'><select name='cs_pt[]' class='cs_input'><option value ='1'>string</option><option value ='2'>int</option><option value='3'>float</option><option value='4'>array</option></select></td><td class='cs_th'><input name='cs_priority[]' value='5' class='cs_input' type='number'/></td><td class='cs_th'><input name='cs_request["+num+"]' value='1' class='cs_checkbox' type='radio' checked/><span>是</span><input name='cs_request["+num+"]' value='0' class='cs_checkbox' type='radio'/><span>否</span></td><td class='cs_th'><select name='cs_showtype[]' class='cs_input showtype'><option value ='1'>input</option><option value ='2'>textarea</option><option value='3'>checkbox</option><option value ='4'>radio</option><option value='5'>select</option></select></td><td class='cs_th'><button type='button' class='btn btn-danger cs_del'>删除</button></td></tr>");
		
	})
	
	$('.cs_add2').click(function(){
		num2++;
		$(this).parents('table').append("<tr><td class='cs_first'><input name='re_name[]' value='' class='cs_input first_input' type='text'/></td><td><input name='re_label[]' value='' class='cs_input' type='text'/></td><td><input name='re_desc[]' value='' class='cs_input' type='text'/></td><td class='cs_th'><select name='re_pt[]' class='cs_input'><option value ='1'>string</option><option value ='2'>int</option><option value='3'>float</option><option value='4'>array</option></select></td><td class='cs_th'><input name='re_priority[]' value='5' class='cs_input' type='number'/></td><td class='cs_th'><input name='re_request["+num2+"]' value='1' class='cs_checkbox' type='radio' checked/><span>是</span><input name='re_request["+num2+"]' value='0' class='cs_checkbox' type='radio'/><span>否</span></td><td class='cs_th'><button type='button' class='btn btn-danger cs_del'>删除</button></td></tr>");
