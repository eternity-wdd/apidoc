...
use app\modules\admin\models\ApiMenus;
$menuData = ApiMenus::getMenuTree(2);
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <!-- Menu Toggle Button -->
                            <a style='width: 65px;height:50px'  href="/admin/default/userout"  class="dropdown-toggle" data-toggle="dropdown" onclick="return confirm('确认退出吗？')">
