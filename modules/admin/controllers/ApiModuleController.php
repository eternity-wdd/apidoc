...
use app\modules\admin\models\ApiServiceSearch;
...
class ApiModuleController extends Controller
{
    ...
    {
        $this->layout = "main1";
        $searchModel = new ApiServiceSearch();
     ...
     * @param string $id
     * @return ApiService the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ApiService::findOne($id)) !== null) {
            return $model;
        } else {
