...
class PointLocation {
    private static $pointOnVertex = true; // Check if the point sits exactly on one of the vertices?
    ...
    public static function pointInPolygon($point, $polygon, $pointOnVertex = true) {
        self::$pointOnVertex = $pointOnVertex;
        ...
        if (self::$pointOnVertex == true and self::pointOnVertex($point, $vertices) == true) {
            return "vertex";
        }
