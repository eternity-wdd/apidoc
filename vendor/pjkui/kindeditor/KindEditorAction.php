...
class KindEditorAction extends Action {
    ...
    public function init() {
       ...
       // $this->php_path =  dirname(__FILE__) . '/';
        $this->php_path =  $this->php_path ?: $_SERVER['DOCUMENT_ROOT'] . '/';
        $this->php_url =  $this->php_url ?: '/';
//根目录路径，可以指定绝对路径，比如 /var/www/attached/
        $this->root_path = $this->root_path ?: $this->php_path . 'upload/';
//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
        $this->root_url = $this->root_url ?: $this->php_url . 'upload/';
//图片扩展名
//            $ext_arr = ['gif', 'jpg', 'jpeg', 'png', 'bmp'],
//文件保存目录路径
        $this->save_path = $this->save_path ?: $this->php_path . 'upload/';
//文件保存目录URL
        $this->save_url = $this->save_url ?: $this->php_url . 'upload/';
//定义允许上传的文件扩展名
//            $ext_arr = array(
...
//            ),
//最大文件大小
        $this->max_size = $this->max_size ?: 1000000;
